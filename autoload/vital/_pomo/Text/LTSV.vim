...
execute join(['function! vital#_pomo#Text#LTSV#import() abort', printf("return map({'dump': '', 'parse': '', 'parse_record': '', 'dump_file': '', 'parse_file': ''}, \"vital#_pomo#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___
let s:save_cpo = &cpo
set cpo&vim
